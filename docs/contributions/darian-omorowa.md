...
| **Sprint 3:** Einbau des dynamischen Pricing-Modells für optionale Rabattstufen. | Commits `c897ba`, `8fe6d13`, `efd463`, `8090c4` in `database.py` und `creator_routes.py`. | Konzeptionell basierend auf dem Dozenten-Feedback von Herrn Eck, Code-Anpassung mittels KI-Unterstützung (siehe AI Directory, Eintrag #06). |
