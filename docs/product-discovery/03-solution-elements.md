...
| :-- | :-- | :-- | :-- | :-- | :-- |
| 1 | Login-Screen | [Login_Screen](material/03-se/ui-screens/Login_Screen.jpeg) | ohne Versionsangabe | Einstieg in die App und Rollenauswahl | Dieser Screen wurde bisher nicht überarbeitet. Später könnte die Rollenauswahl noch klarer zwischen Käufer / Spieler und Creator / Anbieter unterscheiden. |
| 2 | Angebote entdecken | [Angebote_Entdecken_v2](material/03-se/ui-screens/Angebote_Entdecken_v2.jpeg) | v2 | Übersicht aktiver Sammelkäufe | Die Skizze wurde auf Brettspiel-, TTRPG- und Tabletop-Produkte angepasst. Statt generischer Produkte werden Beispiele wie Würfelsets, Dungeon-Terrain, Miniaturen, Würfeltürme und Token-Sets gezeigt. |
| 3 | Anzeige im Detail | [Anzeige_im_Detail_v2](material/03-se/ui-screens/Anzeige_im_Detail_v2.jpeg) | v2 | Detailansicht eines Sammelkaufs | Die Detailseite zeigt nun ein konkretes Beispiel wie ein Drachenwürfel-Set. Zusätzlich werden Creator, Spielsystem, Material, Versandregion, Teilnehmerstand und Rabattstufen angezeigt. |
| 4 | Beitritt bestätigen / Erfolgsseite | [Beitritt_bestätigen_Erfolgsseite](material/03-se/ui-screens/Beitritt_bestätigen_Erfolgsseite.jpeg) | ohne Versionsangabe | Bestätigung des Beitritts zu einem Sammelkauf | Dieser Screen wurde bisher nicht überarbeitet. Inhaltlich passt er schon zum Ablauf, könnte aber später noch Begriffe wie Hive, Sammelkauf-Bedingungen oder konkrete Produktbeispiele enthalten. |
| 5 | Händler-Dashboard / Creator-Dashboard | [Händler_Dashboard_v2](material/03-se/ui-screens/Händler_Dashboard_v2.jpeg) | v2 | Übersicht für Anbieter / Creator | Aus dem allgemeinen Händler-Dashboard wurde inhaltlich ein Creator-Dashboard. Die Beispielangebote beziehen sich nun auf Produkte wie Drachenwürfel-Sets, Dungeon-Terrain, Holz-Würfeltürme und Miniaturen. |
| 6 | Neue Anzeige erstellen | [Neue_Anzeige_Erstellen_v2](material/03-se/ui-screens/Neue_Anzeige_Erstellen_v2.jpeg) | v2 | Formular zum Erstellen eines neuen Sammelkaufs | Die Skizze wurde deutlich domänenspezifischer. Das Formular enthält Felder wie Kategorie, Spielsystem, Material, Mindestteilnehmer, Basispreis und Rabattstufen. |
| 7 | Meine Hives | [Meine_Hives_v2](material/03-se/ui-screens/Meine_Hives_v2.jpeg) | v2 | Übersicht der Sammelkäufe, denen ein Käufer beigetreten ist | Aus „Meine Einkaufsgruppen“ wurde „Meine Hives“. Der Begriff „Hive“ ist eine app-spezifische Bezeichnung für einen Sammelkauf und passt zum Namen DealHive. |
...
![Login-Screen](material/03-se/ui-screens/Login_Screen.jpeg)
...
### 3. Anzeige im Detail v2

![Anzeige im Detail v2](material/03-se/ui-screens/Anzeige_im_Detail_v2.jpeg)
...
### 4. Beitritt bestätigen / Erfolgsseite

![Beitritt bestätigen / Erfolgsseite](material/03-se/ui-screens/Beitritt_bestätigen_Erfolgsseite.jpeg)
...
### 5. Händler-Dashboard / Creator-Dashboard v2

![Händler-Dashboard v2](material/03-se/ui-screens/Händler_Dashboard_v2.jpeg)
...
### 6. Neue Anzeige erstellen v2

![Neue Anzeige erstellen v2](material/03-se/ui-screens/Neue_Anzeige_Erstellen_v2.jpeg)
...
![Meine Hives v2](material/03-se/ui-screens/Meine_Hives_v2.jpeg)
